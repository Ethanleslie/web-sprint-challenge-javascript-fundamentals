...
return count
    ...
    console.log('TASK COUNTER', summation(4))
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals) {
   const newArray = zooAnimals.map((item) => {
    const name = item.animal_name.toLowerCase()
    return `${name}`
   })
...
console.log(lowerCaseNames(zooAnimals))
  ...
  */
  ...
  function USApop(zooAnimals){
    ...
    const totalPop = zooAnimals.reduce((acc, currentValue) => {
